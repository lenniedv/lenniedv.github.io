...
function attachCreateLoop() {
    ...
    function instanceCreateLoop(sketchCanvas, options = {}, options2 = {}) {
        //const sketch = this
        ...
        const framesPerLoop = Math.floor(loopOptions.duration * loopOptions.framesPerSecond)
        console.log('framesPerLoop: ', framesPerLoop)
        console.log('loopOptions: ', loopOptions)

        if (options !== undefined && isNaN(options)) Object.assign(loopOptions, options)
